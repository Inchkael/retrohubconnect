...
@section('content')
    <div class="main-content">
        <div class="container">
            <h1 class="mb-4">Modifier le sujet "{{ $topic->title }}"</h1>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form action="{{ route('admin.forums.topics.update', [$forum, $topic]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="topic-content" name="content" rows="10" required>{{ old('content', $topic->content) }}</textarea>
                        </div>

                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="is_locked" name="is_locked" {{ old('is_locked', $topic->is_locked) ? 'checked' : '' }}>
