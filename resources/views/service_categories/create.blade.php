...
@section('title', 'Créer une nouvelle catégorie de service')
...
@section('content')
    <div class="container">
        <div class="service-card mb-4">
            ...
            <form method="POST" action="{{ route('admin.service_categories.store') }}"
                ...
                <div class="d-flex justify-content-between mt-4">
                    <a href="{{ route('service_categories.index') }}" class="btn btn-outline-secondary btn-lg">
